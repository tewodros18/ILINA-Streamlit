...
with st.expander("📝Back propagation"):
...
with st.expander("Logistic regression"):
    ""
with st.expander("Decision trees [Optional]"):
    ""
...
with st.expander("Dimensionality reduction"):
    ""
with st.expander("Anomaly detection [Optional]"):
    ""
with st.expander("Deep Learning"):
    ''
with st.expander("Forward propagation and loss functions"):
    ''
with st.expander("Backpropagation and gradient descent"):
    ''
with st.expander("Optimizers (SGD, Adam, etc)"):
    ''
with st.expander("Convolutional neural networks"):
    ''
with st.expander("Recurrent neural networks"):
    ''
